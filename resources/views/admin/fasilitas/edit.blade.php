<x-admin-layout title="Edit Fasilitas">
    <section class="rounded-3xl border border-red-100 bg-white p-6 shadow-sm shadow-red-100/60">
        <div class="mb-6">
            ...
            <h2 class="mt-2 text-2xl font-bold text-slate-950">Edit Fasilitas</h2>
        </div>
        ...
        @include('admin.fasilitas.form', ['action' => route('admin.fasilitas.update', $fasilitas), 'fasilitas' => $fasilitas])
    </section>
</x-admin-layout>