            ...
            <div class="mt-6 overflow-hidden rounded-2xl border border-white/10">
                <div class="p-4 sm:p-6">
                    <form method="GET" class="flex w-full gap-2">
                        <input type="search" name="q" value="{{ request('q') }}" placeholder="Cari nama, kategori, atau kapasitas" class="w-full rounded-2xl border border-white/10 bg-slate-950/60 px-4 py-3 text-sm text-white placeholder:text-slate-400 focus:border-cyan-400 focus:ring-cyan-400">
