<x-admin-layout title="Edit Kategori">
    <section class="rounded-3xl border border-red-100 bg-white p-6 shadow-sm shadow-red-100/60">
        <div class="mb-6">
            ...
            <h2 class="mt-2 text-2xl font-bold text-slate-950">Edit Kategori</h2>
        </div>
        ...
        @include('admin.kategori.form', ['action' => route('admin.kategori.update', $kategori), 'kategori' => $kategori])
    </section>
</x-admin-layout>
