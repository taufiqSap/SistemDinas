        ...
        <section class="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/30 backdrop-blur-xl">
            ...
            <div class="mt-6 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                ...
                <div class="space-y-4 rounded-3xl border border-white/10 bg-slate-950/40 p-5">
                    ...
                    <div class="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300">
                        <p class="font-semibold text-white">Bukti Pembayaran</p>
                        @if ($payment?->bukti_pembayaran)
                            <div class="mt-2 flex items-center justify-between gap-3">
                                ...
                                <a href="{{ $payment->bukti_pembayaran_url }}" target="_blank" class="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-3 py-2 text-xs font-semibold text-cyan-100">
                                    Lihat File
                                </a>
                            </div>
                        @else
                            <p class="mt-2 text-slate-400">Belum ada bukti pembayaran yang diupload.</p>
                        @endif
                    </div>
                </div>
            </div>
