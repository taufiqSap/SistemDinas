            ...
            <div class="mt-6 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                ...
                <div class="space-y-4 rounded-3xl border border-red-100 bg-white p-5 shadow-sm">
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div><p class="text-xs uppercase tracking-[0.2em] text-slate-500">No Hp</p><p class="mt-1 font-semibold text-slate-950">{{ $booking->user->phone?->no_hp ?? '-' }}</p></div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            @if ($booking->dokumen_pdf)
                                <a href="{{ Storage::disk('public')->url($booking->dokumen_pdf) }}" target="_blank" 
