<x-admin-layout title="Edit Tipe Sewa">
    <section class="rounded-3xl border border-red-100 bg-white p-6 shadow-sm shadow-red-100/60">
        <div class="mb-6">
            ...
            <h2 class="mt-2 text-2xl font-bold text-slate-950">Edit Tipe Sewa</h2>
        </div>
        ...
        @include('admin.tipe-sewa.form', ['action' => route('admin.tipe-sewa.update', $tipeSewa), 'tipeSewa' => $tipeSewa])
    </section>
</x-admin-layout>